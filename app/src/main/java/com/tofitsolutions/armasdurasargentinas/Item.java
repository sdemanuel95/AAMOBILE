...
public class Item implements Serializable{
    ...
    public Item(long idpedido,long item, String posicion){
        this.idpedido = idpedido;
        this.item = item;
        this.posicion = posicion;
    }
    public Item(long idpedido,long item, String posicion, String estructura){
        this.idpedido = idpedido;
        this.item = item;
        this.posicion = posicion;
    ...
    public Item(long id, long idpedido, long item, String posicion, String acero, String material, String diametro, String cantidad,
    ...
    public Item(long idpedido, long item) {
        this.idpedido = idpedido;
        this.item = item;
    }
