...
public class PasadoresActivity extends AppCompatActivity implements TextWatcher {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_datosUsuario.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(PasadoresActivity.this, DatosUsuarioPasadoresActivity.class);
                finish();
                startActivity(i);
            }
        });
        ...
        bt_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!esDouble(et_kg.getText().toString()) || et_precinto.length() != 24){

                    AlertDialog.Builder builder = new AlertDialog.Builder(PasadoresActivity.this, R.style.Theme_AppCompat_DayNight_Dialog_Alert);
                    builder.setTitle("Atencion!");
                    builder.setMessage("Validar que el peso sea numérico y que el precinto contenga 24 dígitos");
                    ...
                    Intent i = new Intent(PasadoresActivity.this, Pasadores2Activity.class);
        ...
        bt_cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PasadoresActivity.this, PrincipalActivity.class);
                finish();
                startActivity(i);
            }
        });
    ...
    public void afterTextChanged(Editable editable) {
        ...
        if (nro.length() == 24) {
            if (et_precinto.length() == 24) {
                ...
                //Verifica si es barra plana (AL-220)
                if(!ingreso.getDescripcion().toUpperCase().contains("AL-220")){
                    AlertDialog.Builder builder = new AlertDialog.Builder(PasadoresActivity.this, R.style.Theme_AppCompat_DayNight_Dialog_Alert);
                    builder.setTitle("Atencion!");
                    builder.setMessage("El material ingresado no es barra plana.");
                    builder.setCancelable(false);
                    builder.setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
